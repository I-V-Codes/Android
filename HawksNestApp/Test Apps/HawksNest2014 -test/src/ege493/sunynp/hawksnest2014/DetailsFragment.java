...
public class DetailsFragment extends Fragment {
	...
	private TextView dormTextView; // displays contact's dorm
	private TextView roomTextView; // displays contact's room
	private TextView extTextView; // displays contact's ext
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		dormTextView = (TextView) view.findViewById(R.id.dormTextView);
		roomTextView = (TextView) view.findViewById(R.id.roomTextView);
		extTextView = (TextView) view.findViewById(R.id.extTextView);
		return view;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_edit:
			...
			arguments.putCharSequence("dorm", dormTextView.getText());
			arguments.putCharSequence("room", roomTextView.getText());
			arguments.putCharSequence("ext", extTextView.getText());
	...
	private class LoadContactTask extends AsyncTask<Long, Object, Cursor> {
		RADatabaseConnector databaseConnector = new RADatabaseConnector(
				getActivity());
		...
		protected void onPostExecute(Cursor result) {
			...
			int dormIndex = result.getColumnIndex("dorm");
			int roomIndex = result.getColumnIndex("room");
			int extIndex = result.getColumnIndex("ext");

			// fill TextViews with the retrieved data
			nameTextView.setText(result.getString(nameIndex));
			dormTextView.setText(result.getString(dormIndex));
			roomTextView.setText(result.getString(roomIndex));
			extTextView.setText(result.getString(extIndex));
			...
			builder.setPositiveButton(R.string.button_delete,
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int button) {
							final RADatabaseConnector databaseConnector = new RADatabaseConnector(
									getActivity());
