      ...
      AddEditRA.AddEditRAListener
{
   ...
   // display ContactListFragment when RAList first loads
   @Override
   ...
   // display the AddEditRA to add a new contact
   @Override
   public void onAddContact()
   {
      if (findViewById(R.id.fragmentContainer) != null)
         displayAddEditRA(R.id.fragmentContainer, null); 
      else
         displayAddEditRA(R.id.rightPaneContainer, null);
   }
   
   // display fragment for adding a new or editing an existing contact
   private void displayAddEditRA(int viewID, Bundle arguments)
   {
      AddEditRA addEditFragment = new AddEditRA();
      
      if (arguments != null) // editing existing contact
         addEditFragment.setArguments(arguments);
      
      // use a FragmentTransaction to display the AddEditRA
      FragmentTransaction transaction = 
         getFragmentManager().beginTransaction();
      transaction.replace(viewID, addEditFragment);
      transaction.addToBackStack(null);
      transaction.commit(); // causes AddEditRA to display
   }
   ...
   // display the AddEditRA to edit an existing contact
   @Override
   public void onEditContact(Bundle arguments)
   {
      if (findViewById(R.id.fragmentContainer) != null) // phone
         displayAddEditRA(R.id.fragmentContainer, arguments); 
      else // tablet
         displayAddEditRA(R.id.rightPaneContainer, arguments);
   }
